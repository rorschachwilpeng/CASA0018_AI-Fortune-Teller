...
const unsigned long MIN_QUESTION_DURATION = 5000;
...
void setup()
{
    ...
    Serial.println("Device ready! Press and hold the touch sensor for at least 5 seconds while speaking your question...");
...
void loop()
{
    ...
    if (touchState == HIGH) {
        ...
        if (!is_touch_active) {
            ...
            Serial.println("Touch sensor activated. Please speak your question for at least 5 seconds...");
        ...
        if (is_touch_active) {
            ...
            if (touch_duration >= MIN_QUESTION_DURATION) {
                ...
                // Touch was too short
                Serial.println("Question too short (less than 5 seconds). Please try again with a longer question.");
