...
const char* ei_classifier_inferencing_categories[] = { "negative", "neutral", "positive" };

ei_dsp_named_axis_t ei_dsp_config_22_named_axes[] = {
    { .name = "Signal", .axis = 0 }
};
size_t ei_dsp_config_22_named_axes_size = 1;
EI_CLASSIFIER_DSP_AXES_INDEX_TYPE ei_dsp_config_22_axes[] = { 0 };
...
ei_learning_block_config_tflite_graph_t ei_learning_block_config_23 = {
    .implementation_version = 1,
...
const ei_impulse_t impulse_654681_0 = {
    .project_id = 654681,
    .project_owner = "YouTian Peng",
    .project_name = "casa0018",
    .impulse_id = 7,
    .impulse_name = "Impulse #7",
    .deploy_version = 2,
...
ei_impulse_handle_t impulse_handle_654681_0 = ei_impulse_handle_t( &impulse_654681_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_654681_0;
